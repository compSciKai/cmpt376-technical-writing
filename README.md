...
CMPT376 had a heavy course load of writing activities. In completion of these activities, I've learned to firstly create rough drafts of writing content quickly, allowing for more creative forms of communication, and secondly learned to revise materials to ensure content is written most effectively. 

## Applications in Technical Writing

Notible projects in CMPT376 included revising a published research paper, peer revisions, real world revision applications, individual technical reports, and a writing journal. The Real World Revisions assignment had students choose 60 Github repos, and make edits on written content. It was up to the repo owner if revisions were implemented (many were). Peer revisions were conducted on technical reports 1 & 2 (below). The writing journal had writing activities needing completion every 3 days. 
